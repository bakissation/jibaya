# Contributing to @bakissation/jibaya
...
```bash
git clone https://github.com/bakissation/jibaya.git
cd jibaya
npm install
npm run build
npm test
...
- On merge per channel: **`dev` → alpha**, **`staging` → beta**, **`main` → stable**. Notes go to [GitHub Releases](https://github.com/bakissation/jibaya/releases).
